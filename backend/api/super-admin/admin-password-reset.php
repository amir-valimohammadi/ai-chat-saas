...
require_once __DIR__.'/../../includes/admin-management.php';require_once __DIR__.'/../../includes/admin-impersonation.php';
...
admin_impersonation_revoke_for_admin($pdo,$id,(int)$actor['id'],'Administrator password reset');

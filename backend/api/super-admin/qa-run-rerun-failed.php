...
try{
    ...
    $permission=$source['profile']==='security'?'tests.run_security':($source['profile']==='operational'?'tests.run_operational':($source['profile']==='browser'?'tests.run_browser':($source['profile']==='full'?'tests.run_full':'tests.run_safe')));require_admin_permission($user,$permission);

...
CREATE TABLE `automation_sla_policies` (
  ...
  `pause_statuses_json` longtext DEFAULT NULL,
...
CREATE TABLE `conversation_sla_status` (
  ...
  `uses_business_hours` tinyint(1) NOT NULL DEFAULT 0,
  `sla_timezone` varchar(80) NOT NULL DEFAULT 'Asia/Tehran',
  `pause_statuses_json` longtext DEFAULT NULL,
  ...
  `paused_status` varchar(50) DEFAULT NULL,
  `resolution_remaining_seconds` int(10) unsigned DEFAULT NULL,
  `total_paused_seconds` bigint(20) unsigned NOT NULL DEFAULT 0,
  `warning_sent_at` datetime DEFAULT NULL,
  `resolution_warning_sent_at` datetime DEFAULT NULL,

...
function profileLabel(value:Run["profile"]){return value==="quick"?"سریع":value==="full"?"کامل":value==="operational"?"عملیاتی":value==="browser"?"مرورگری":"امنیتی"}
